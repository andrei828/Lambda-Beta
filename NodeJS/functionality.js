...
functionality.listTodos = function(req, res) {
	...
	var id = 1//tokens[req.query.token];
...
functionality.removeNote = function(req, res) {
	...
	sqlservice.removeNoteById(printAndReturn, note)
}
...
functionality.removeTodo = function(req, res) {
	...
	sqlservice.removeTodoById(printAndReturn, todo)
}
...
functionality.removeEvent = function(req, res) {
	...
	sqlservice.removeEventById(printAndReturn, event)
}
